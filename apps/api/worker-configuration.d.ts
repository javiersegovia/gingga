/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b9f9a1e8ac516cb4baeffc7b2aa59fa8)
// Runtime types generated with workerd@1.20250422.0 2025-04-20 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		GATEWAY_BASE_OPENAI_URL: string;
		GATEWAY_BASE_OPENROUTER_URL: string;
		...
		COMPOSIO_GMAIL_INTEGRATION_ID: string;
		COMPOSIO_GOOGLESHEETS_INTEGRATION_ID: string;
		COMPOSIO_GOOGLECALENDAR_INTEGRATION_ID: string;
		COMPOSIO_GOOGLEDOCS_INTEGRATION_ID: string;
		COMPOSIO_LOGGING_LEVEL: string;
		N8N_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "GATEWAY_BASE_URL" | "DATABASE_URL" | "TURSO_AUTH_TOKEN" | "TURSO_API_TOKEN" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_REDIRECT_URI" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI" | "SESSION_SECRET" | "AUTH_SECRET" | "RESEND_API_KEY" | "OPENROUTER_API_KEY" | "GATEWAY_BASE_OPENAI_URL" | "GATEWAY_BASE_OPENROUTER_URL" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "GH_TOKEN" | "VITE_SITE_DOMAIN" | "VITE_SITE_URL" | "VITE_API_URL" | "VITE_ASSETS_URL" | "VITE_SUPPORT_EMAIL" | "VITE_RESEND_EMAIL_FROM" | "KV_URL" | "KV_REST_API_READ_ONLY_TOKEN" | "REDIS_URL" | "KV_REST_API_TOKEN" | "KV_REST_API_URL" | "COMPOSIO_API_KEY" | "COMPOSIO_GMAIL_INTEGRATION_ID" | "COMPOSIO_GOOGLESHEETS_INTEGRATION_ID" | "COMPOSIO_GOOGLECALENDAR_INTEGRATION_ID" | "COMPOSIO_GOOGLEDOCS_INTEGRATION_ID" | "COMPOSIO_LOGGING_LEVEL" | "N8N_API_KEY" | "ADMIN_USER_IDS">> {}
}
