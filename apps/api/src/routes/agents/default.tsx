...
export const agentDefaultRoute = new Hono()

// TODO: Create Hono Middleware

// Define the POST route using Hono
agentDefaultRoute.post('/', async (c) => {
  try {
    const { user } = await createContext(c)
