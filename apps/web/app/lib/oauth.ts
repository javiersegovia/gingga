...
export type OAuthProvider = string | 'google'
// | 'github'
// | 'x'
// | 'supabase'
// | 'confluence'
...
export interface OAuthProviderConfig {
  ...
  services: Record<OAuthService, OAuthServiceConfig>
  defaultService: OAuthService
}
...
export function getServiceIdFromScopes(
  provider: OAuthProvider,
  scopes: string[],
): string {
  const providerConfig = OAUTH_PROVIDERS[provider]
...
// WE WILL HANDLE THE OAUTH INTEGRATION <WITH A THIRD PARTY SERVICE
