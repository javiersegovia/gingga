...
export interface AIModel {
  ...
  name: string
  provider: 'Anthropic' | 'Google' | 'Meta' | 'Mistral' | 'OpenAI' | 'xAI' | 'Deepseek'
...
export const modelIconPaths: Record<AIModel['provider'], string> = {
  ...
  Google: `${ASSETS_URL}/ai-logos/google.svg`,
  Meta: `${ASSETS_URL}/ai-logos/meta.svg`,
  Mistral: `${ASSETS_URL}/ai-logos/mistral.svg`,
  OpenAI: `${ASSETS_URL}/ai-logos/openai.svg`,
  xAI: `${ASSETS_URL}/ai-logos/xai.svg`,
  Deepseek: `${ASSETS_URL}/ai-logos/deepseek.svg`,
}
...
const deepseekModels: AIModel[] = [
  {
    ...
    outputPricing: 2.4,
    description:
      'Deepseek R1 is optimized for code generation and technical tasks. It excels at understanding and generating code across multiple programming languages while maintaining high accuracy and contextual understanding.',
...
const googleModels: AIModel[] = [
  {
    ...
    outputPricing: 0.6,
    description:
      'It introduces notable enhancements in multimodal understanding, coding capabilities, complex instruction following, and function calling. These advancements come together to deliver more seamless and robust agentic experiences.',
...
// export const availableModels = availableModelIds.map((id) => {
