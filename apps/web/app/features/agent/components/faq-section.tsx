              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <AccordionTrigger
                      variant="ghost"
                      className="font-body rounded-base hover:text-brand-blue dark:hover:text-foreground dark:text-muted-foreground has-data-[state=open]:text-brand-blue px-4 pt-6 text-left text-lg font-medium text-black hover:no-underline sm:text-xl md:px-8 md:pt-8 md:text-2xl md:text-xl"
                    >
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent
