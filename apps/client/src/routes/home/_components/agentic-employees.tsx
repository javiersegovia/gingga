  ...
  const agents: Agent[] = [
    {
      ...
      imageSrc: `${env.VITE_ASSETS_URL}/automatas/agent_4.webp`,
      theme: {
    ...
    },
    {
      ...
      imageSrc: `${env.VITE_ASSETS_URL}/automatas/agent_1.webp`,
      theme: {
    ...
    },
    {
      ...
      imageSrc: `${env.VITE_ASSETS_URL}/automatas/agent_3.webp`,
      theme: {
              ...
              <div className="flex w-full max-w-xl justify-center">
                <div className="overflow-hidden rounded-xl">
                  <div className="relative">
                    <img
                      src={`${env.VITE_ASSETS_URL}/automatas/agent_10.webp`}
                      alt="Custom AI Agent"
