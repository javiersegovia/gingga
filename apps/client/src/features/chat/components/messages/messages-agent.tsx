...
import { PreviewMessage, ThinkingMessage } from './message-agent.client'
...
interface MessagesProps {
  ...
  messages: UseAgentChatResult['messages']
  setMessages: UseAgentChatResult['setMessages']
  setInput: UseAgentChatResult['setInput']
  append: UseAgentChatResult['append']
