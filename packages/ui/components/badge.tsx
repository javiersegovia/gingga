...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-base border-2 border-border px-2.5 font-base py-1 text-xs [&_svg]:pointer-events-none [&_svg]:shrink-0 transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2',
  {
    variants: {
      variant: {
...
function Badge({
  ...
  return (
    <div
      ...
      {...props}
    >
      {variant === 'premium' && <StarIcon className="mr-1.5 h-3.5 w-3.5 fill-current" />}
