 ...
 */
function CommandEmpty({ ref: forwardedRef, className, ...props }: React.ComponentProps<typeof CommandPrimitive.Empty> & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
function MultipleSelector({ ref, value, onChange, placeholder, defaultOptions: arrayDefaultOptions = [], options: arrayOptions, delay, onSearch, onSearchSync, loadingIndicator, emptyIndicator, maxSelected = Number.MAX_SAFE_INTEGER, onMaxSelected, hidePlaceholderWhenSelected, disabled, groupBy, className, badgeClassName, selectFirstItem = true, creatable = false, triggerSearchOnFocus = false, commandProps, inputProps, hideClearAllButton = false }: MultipleSelectorProps & { ref?: React.RefObject<MultipleSelectorRef | null> }) {
