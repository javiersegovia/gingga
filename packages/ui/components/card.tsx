...
function Card({ className, hover, design, shadowColor, style, ...props }: CardProps) {
...
function CardContent({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div data-slot="card-content" className={cn('m-6', className)} {...props} />
}
